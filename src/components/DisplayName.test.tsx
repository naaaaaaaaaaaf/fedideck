...
describe('DisplayName', () => {
    ...
    describe('accounts with custom emojis', () => {
        ...
        it('should handle multiple emojis', () => {
            ...
            expect(imgs[0]).toHaveAttribute('src', 'https://example.com/emojis/star.png');
            expect(imgs[1]).toHaveAttribute('src', 'https://example.com/emojis/fire.png');
        });
    ...
    describe('HTML escaping (XSS prevention)', () => {
        ...
        it('should escape HTML in displayName with emojis', () => {
            ...
            expect(imgs[0]).toHaveAttribute('src', 'https://example.com/emojis/cat.png');
